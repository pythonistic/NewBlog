...
insert into post values (-101, -101, now(), now(), 'Test Post', 'This is my test post...', 'This is my test post', 'This is my test post. I hope you truly enjoy it. <script>alert("Uh oh")</script>', 'This is my test post. I hope you truly enjoy it.', -101, (select id from post_status where status='publish'), (select id from approval where status='approved'), null, (select id from post_type where type='post'), 'text/plain', null, null, (select id from trackback_status where status='open'), 'http://post1', (select id from comment_status where status='open'), 3);
